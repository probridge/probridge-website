jQuery(document).ready(function() {
	...
	itemTemplate : '<li>' + '<a rel="prettyPhoto[pp_gal]" href="{{image}}">' + '<img src="{{image_s}}" alt="{{title}}" />' + '</a>' + '</li>'
    }, function(data) {
...
$(document).ready(function() {
	...
	allow_resize : true, /*
				 * Resize the photos bigger than viewport.
				 * true/false
				 */
	default_width : 500,
	default_height : 344,
	...
	autoplay : true, /*
			     ...
			     */
	modal : false, /*
			 * If set to true, only the close button will close the
			 * window
			 */
	deeplinking : true, /*
			     * Allow prettyPhoto to update the url to enable
			     * deeplinking.
			     */
	overlay_gallery : true, /*
				 * If set to true, a gallery will overlay the
				 * fullscreen image on mouse over
				 */
	keyboard_shortcuts : true, /*
				     * Set to false if you open forms inside
				     * prettyPhoto
				     */
...
jQuery('#maps').gMap({
	...
	latitude : 31.199717,
	longitude : 121.4352,
	html : "<h4>ProBridge Technology</h4>云计算服务合作伙伴",
	popup : true
    } ]
});
